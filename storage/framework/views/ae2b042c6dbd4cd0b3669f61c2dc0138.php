...
<table class="info-table">
    <tr>
        ...
        <td style="width: 75%; font-size: 11px;"><?php echo e($record->user_last_name); ?></td>
    </tr>
    <tr>
        <td><strong>OIB</strong></td>
        <td style="font-size: 11px;"><?php echo e($record->user_oib); ?></td>
    </tr>
    <tr>
        <td><strong>Naziv radnog mjesta / poslova</strong></td>
        <td style="font-size: 11px;"><?php echo e($record->workplace); ?></td>
    </tr>
    <tr>
        <td><strong>Organizacijska jedinica</strong></td>
        <td style="font-size: 11px;"><?php echo e($record->organization_unit); ?></td>
    </tr>
</table>
...
<table>
    ...
    <tbody>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $record->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                <td><?php echo e($index + 1); ?></td>
                <td><?php echo e($item->equipment_name); ?></td>
                <td><?php echo e($item->standard); ?></td>
                <td><?php echo e($item->size); ?></td>
                <td><?php echo e($item->duration_months); ?></td>
                <td><?php echo e(\Carbon\Carbon::parse($item->issue_date)->format('d.m.Y.')); ?></td>
                <td class="sig-cell">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($item->signature)): ?>
                        <?php
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($base64): ?>
                            <img src="data:<?php echo e($mime); ?>;base64,<?php echo e($base64); ?>" class="signature-img" alt="potpis">
                        <?php else: ?>
                            -
                ...
                <td><?php echo e($item->return_date ? \Carbon\Carbon::parse($item->return_date)->format('d.m.Y.') : '-'); ?></td>
            </tr>
...
<?php /**PATH C:\Users\Korisnik\znr-lider-v4\resources\views/pdf/ozo-pdf.blade.php ENDPATH**/ ?>