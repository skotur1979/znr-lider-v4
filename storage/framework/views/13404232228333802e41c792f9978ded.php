...
<?php $component->withAttributes([]); ?>
    ...
    <div class="znr-quick-wrap">
        ...
        <div class="znr-quick-grid">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $this->selectedActions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $action): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a
                    href="<?php echo e($action['url']); ?>"
                    class="znr-quick-card <?php echo e($action['color']); ?>"
                    title="<?php echo e($action['label']); ?>"
                >
                    <div class="znr-quick-icon">
                        <?php if (isset($component)) { $__componentOriginalbfc641e0710ce04e5fe02876ffc6f950 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalbfc641e0710ce04e5fe02876ffc6f950 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.icon','data' => ['icon' => $action['icon'],'class' => 'h-5 w-5']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['icon' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($action['icon']),'class' => 'h-5 w-5']); ?>
...
<?php endif; ?>
                    ...
                    <div class="znr-quick-body">
                        <div class="znr-quick-label"><?php echo e($action['label']); ?></div>
                        <div class="znr-quick-desc"><?php echo e($action['description']); ?></div>
                    </div>
...
<?php endif; ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showEditor): ?>
            ...
            <div class="znr-quick-modal-box">
                ...
                <div class="znr-quick-modal-body">
                    <div class="znr-quick-editor-grid">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $this->availableActions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $action): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                                $active = in_array($action['key'], $editorSelection, true);
                                $disabled = ! $active && count($editorSelection) >= 4;
                            ?>

                            <label class="znr-quick-option <?php echo e($active ? 'active' : ''); ?>">
                                <input
                                    type="checkbox"
                                    wire:click="toggleAction('<?php echo e($action['key']); ?>')"
                                    <?php if($active): echo 'checked'; endif; ?>
                                    <?php if($disabled): echo 'disabled'; endif; ?>
                                >

                                <div>
                                    <div class="znr-quick-option-title"><?php echo e($action['label']); ?></div>
                                    <div class="znr-quick-option-desc"><?php echo e($action['description']); ?></div>
                                </div>
                            </label>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                    ...
                    <div class="znr-quick-limit">
                        Odabrano: <?php echo e(count($editorSelection)); ?> / 4
                    </div>
                </div>
...
<?php endif; ?><?php /**PATH C:\Users\Korisnik\znr-lider-v4\resources\views/filament/widgets/quick-actions-widget.blade.php ENDPATH**/ ?>