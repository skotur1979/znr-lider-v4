...
<?php endif; ?>
                            ...
                            <div
                                class="fi-fo-file-upload-editor-control-panel-group"
                            >
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $getImageEditorActions(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $groupedActions): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\Korisnik\znr-lider-v4\vendor\filament\forms\resources\views/components/file-upload.blade.php ENDPATH**/ ?>