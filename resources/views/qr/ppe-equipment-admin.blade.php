...
<div class="page">
    ...
    <div class="page-title">
        ...
        <h1>
            QR kod - {{ $ppeEquipment->name }}
        </h1>

        <p>
            Upravljanje QR kodom OZO opreme
        </p>
    ...
    <div class="toolbar">
        ...
        @if(
            ...
            <form
                ...
                onsubmit="
                    return confirm(
                        'Jesi li siguran da želiš deaktivirati QR kod?'
                    );
                "
            >
        ...
        <div class="details">
            ...
            <div class="card">
                ...
                >
                    ...
                    ovoj OZO opremi i njezinim
                    certifikatima i uputama.
