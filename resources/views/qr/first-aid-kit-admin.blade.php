...
<head>
    ...
    <title>
        QR - Prva pomoć - {{ $firstAidKit->location }}
    </title>
...
<div class="page">
    ...
    <div class="page-title">
        ...
        <h1>
            QR kod - {{ $firstAidKit->location }}
        </h1>

        <p>
            Upravljanje QR kodom ormarića prve pomoći
        </p>
