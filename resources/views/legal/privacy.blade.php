...
<head>
    <meta charset="UTF-8">
    <title>Pravila privatnosti - ZNR Lider</title>
</head>
...
<p>
    ...
    Verzija: {{ config('legal.privacy_version') }}<br>
...
<p>Podaci se mogu dijeliti samo kada je to potrebno za:</p>

<ul>
    <li>pružanje ugovorene usluge,</li>
    <li>hosting, servere, e-mail sustave i tehničku infrastrukturu,</li>
    <li>sigurnosne kopije i održavanje sustava,</li>
    <li>knjigovodstvene, porezne ili pravne obveze,</li>
    <li>postupanje po zahtjevu nadležnih tijela kada za to postoji zakonska obveza.</li>
</ul>
...
<ul>
    <li>koristiti sigurnu lozinku,</li>
    <li>ne dijeliti pristupne podatke s neovlaštenim osobama,</li>
    <li>odmah obavijestiti ZNR Lider ako sumnja na neovlašteni pristup,</li>
    <li>osigurati da njegovi zaposlenici ili suradnici koriste sustav isključivo u skladu s dodijeljenim ovlastima.</li>
</ul>
