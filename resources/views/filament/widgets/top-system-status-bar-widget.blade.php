...
<x-filament-widgets::widget>
    ...
    <style>
        ...
        .tsb-module-expired-low{
            border:1px solid rgba(245,158,11,.95) !important;
            background:#fff0c2 !important;
            box-shadow:0 8px 22px rgba(245,158,11,.24) !important;
        }

        .dark .tsb-module-expired-low{
            border:1px solid rgba(245,158,11,.90) !important;
            background:rgba(245,158,11,.28) !important;
            box-shadow:0 8px 22px rgba(245,158,11,.25) !important;
        }

        .tsb-module-expired-high{
            border:1px solid rgba(239,68,68,.95) !important;
            background:#ffd6d6 !important;
            box-shadow:0 10px 26px rgba(239,68,68,.30) !important;
        }

        .dark .tsb-module-expired-high{
            border:1px solid rgba(239,68,68,.92) !important;
