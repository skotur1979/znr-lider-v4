            ...
            <div class="onto-meta-cell">
                <div class="onto-field">
                    ...
                    <div class="onto-value">
                        {{ $record->organization?->company_name ?? $record->organization?->name ?? '-' }}
                    </div>
                </div>
                ...
                <div class="onto-field">
                    ...
                    <div class="onto-value">
                        {{ $record->organization?->registered_office ?? $record->organization?->address ?? '-' }}
                    </div>
                </div>
            ...
            <table class="onto-table">
                ...
                <tbody>
                    @forelse ($entries as $entry)
                        <tr>
                            <td class="onto-center">{{ $entry->entry_no }}</td>
