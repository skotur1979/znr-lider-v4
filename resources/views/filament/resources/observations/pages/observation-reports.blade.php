    ...
    <div class="obs-report">
            ...
            <div class="obs-filters">
                ...
                <div>
                    ...
                    >
                        ...
                        <option value="Negative Observation">
                            Negativno
                        </option>

                        <option value="Positive Observation">
                            Pozitivno
                        </option>
        ...
        <div class="obs-cards">
            ...
            <div class="obs-card">
                ...
                <div class="obs-card-value obs-info">
                    {{ $summary['qrPublic'] ?? 0 }}
                </div>
