...
class IncidentsOverview extends StatsOverviewWidget
{
    ...
    protected function getStats(): array
    {
        ...
        /*
         * Query tablice već koristi tenant scope.
         */
        ...
        /*
         * Za broj dana bez LTA gledamo cijelu organizaciju,
         * ne samo trenutno prijavljenog korisnika.
         */
        $lastLtaDate = IncidentResource::getEloquentQuery()
            ->withoutTrashed()
            ->where(
                'type_of_incident',
                'LTA'
        ...
        if ($lastLtaDate) {
            $lastLta = Carbon::parse(
                $lastLtaDate
            )->startOfDay();

            $daysWithoutLta = $lastLta
                ->diffInDays(
                    Carbon::today()
                );
