...
class IncidentResource extends BaseResource
{
    ...
    protected static bool $usesSoftDeletes =
        true;
    ...
    protected static function incidentTypeDescription(
        ?string $type
    ): ?string {
        return match ($type) {
            'LTA' => 'Ozljeda na radu',
    ...
    protected static function calculateWorkingDaysLost(
        ...
        $startDate = static::parseIncidentDate(
            $start
        );

        $endDate = static::parseIncidentDate(
            $end
        );
         ...
         * do datuma povratka.
         *
         * Dan povratka nije izgubljeni radni dan,
         * zato se oduzima jedan dan.
         */
        return max(
            (int) $startDate->diffInWeekdays(
                $endDate
            ) - 1,
            0
        );
                                        ...
                                        function (
                                            ...
                                            if (
                                                ...
                                                * 1024
                                                ...
                                                Notification::make()
                                                    ->title(
                                                        "Ukupna veličina svih datoteka ne smije biti veća od {$maxTotalMB} MB."
                                                    )
                                                    ->danger()
                                                    ->persistent()
                                                    ->send();
                ...
                TextColumn::make(
                    ...
                    ->description(
                        fn (
                            ...
                            static::incidentTypeDescription(
                                $record
                                    ->type_of_incident
                            ),
                        position: 'below'
    ...
    public static function getPages(): array
    {
        return [
            ...
            'edit' =>
                Pages\EditIncident::route(
                    '/{record}/edit'
                ),

            'view' =>
                Pages\ViewIncident::route(
                    '/{record}'
                ),
        ];
    }
