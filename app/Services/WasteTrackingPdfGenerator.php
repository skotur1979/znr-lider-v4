...
class WasteTrackingPdfGenerator
{
    public function generate(
        ...
        $templatePath =
            FormVersionService::templatePath(
                'plo',
                $formVersion
            );
