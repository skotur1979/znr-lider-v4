...
class EmployeesImport implements ToCollection
{
    ...
    public function __construct()
    {
        ...
        /*
         * Import zaposlenika je
         * organizacijski import.
         *
         * Glavni korisnik i podkorisnici
         * importiraju zaposlenike svoje
         * organizacije.
         *
         * Superadmin ne importira zaposlenike.
         */
        if (
            ! $user
            || $user->isSuperAdmin()
    ...
    public function collection(
        ...
        for (
            ...
            /*
             * Zaposlenika uvijek tražimo
             * samo unutar iste organizacije.
             */
            $query =
                Employee::query()
                    ->where(
            ...
            /*
             * Ako postoji OIB koristimo
             * isključivo OIB.
             *
             * Ako nema OIB-a koristimo
             * dodatne kombinacije.
             */
            if ($oib) {
                $employee =
                ...
                'handling_flammable_materials_valid_from' =>
                    $this->parseDate(
                        $this->value(
                            $row,
                            $map,
                            'rukovanje_zapaljivim_tvarima_od'
                        )
                    ),
                ...
                'handling_flammable_materials_valid_until' =>
                    $this->parseDate(
                        $this->value(
                            $row,
                            $map,
                            'rukovanje_zapaljivim_tvarima_do'
                        )
                    ),
            ...
            /*
             * Certifikati su vezani uz
             * konkretnog zaposlenika,
             * pa time nasljeđuju njegov
             * tenant.
             */
    ...
    private function importCertificates(
        ...
        for (
            ...
            /*
             * Certifikat uvijek tražimo
             * preko konkretnog Employeea.
             */
            $certificate =
    ...
    private function normalizeKey(
        ...
        return match ($key) {
            ...
            /*
             * Za prvu pomoć koristimo
             * samo datum osposobljavanja.
             */
            'prva_pomoc_od'
                => 'prva_pomoc_od',
